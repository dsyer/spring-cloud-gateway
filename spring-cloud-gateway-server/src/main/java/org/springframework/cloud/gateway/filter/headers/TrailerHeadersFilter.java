...
public interface TrailerHeadersFilter {
	...
	static Mono<HttpHeaders> filter(List<HttpHeadersFilter> filters, Mono<HttpHeaders> input,
	 ...
	 */
	Mono<HttpHeaders> filter(Mono<HttpHeaders> input, ServerWebExchange exchange);
